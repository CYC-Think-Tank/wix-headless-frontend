...
export default function BottomCTA() {
  return (
    <section className="w-full bg-white py-24 px-6 lg:px-8 text-center flex flex-col items-center justify-center relative overflow-hidden border-t border-gray-100">
      ...
      <button className="flex items-center justify-center gap-3 px-10 py-5 bg-cyc-teal hover:bg-[#00cce6] text-cyc-navy font-black text-xl rounded-2xl transition-colors duration-300">
        Register Now
